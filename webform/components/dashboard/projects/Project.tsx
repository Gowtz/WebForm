...
import { Projects as ProjectType} from "@/lib/types";
export default async function Projects() {


  const projects:ProjectType[] =[{createdAt:"asd",description:"asd",id:"asd",isActive:false,name:"asd",updatedAt:"asd",webURL:"asd" }]
